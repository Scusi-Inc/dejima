...
- [x] **GitHub Pages site (`web/index.html` + `web/install.sh`)** — works at `aoos.github.io/dejima/` once Pages is enabled. (hours)
...
- [ ] **🧑 USER TASK — Enable GitHub Pages from `master:/web/`** so `aoos.github.io/dejima/install.sh` works. See [`docs/distribution.md`](distribution.md). (5 min, free)
