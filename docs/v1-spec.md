...
- `POST  /v1/islands/:name/clone`         — duplicate an island (`dejima clone`): new config + copies of the workspace + home volumes; credentials/git history come along, Port grants do not
