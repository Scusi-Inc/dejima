...
| 6 (Phase B) — live nightly: macOS runner + Tier-3 suite (setup: `docs/testing/dejimaqa-runner-setup.md`) | `docs/lanes/lane-6-phase-b.md` | "Read `docs/lanes/lane-6-phase-b.md` and follow it — it's your full brief." |
